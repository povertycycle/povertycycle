...
export const TALENT_TREES : { [key: string] : TalentIcon[] } = {
    ...
    "study": [
        ...
        { id: 14, x: 0, y: 4, children: [null, 4.3, 1.4] }, { id: 15, x: 1, y: 4 }, { id: 16, x: 2, y: 4, children: [null, 0] }, { id: 17, x: 4, y: 4, children: [1.4, 0, 1] }, { id: 18, x: 6, y: 4, children: [null, 0, 1.4] }, { id: 19, x: 7, y: 4, children: [null, 0] }, { id: 20, x: 8, y: 4, children: [null, 4.3] },
